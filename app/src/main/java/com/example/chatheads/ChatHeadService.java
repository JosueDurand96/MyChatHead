...
public class ChatHeadService extends Service implements View.OnTouchListener {
    ...
    // The Android WindowManager is a system service,
    // which is responsible for managing the z-ordered list of windows,
    // which windows are visible, and how they are laid out on screen.
